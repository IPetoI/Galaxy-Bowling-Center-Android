...
import com.example.galaxybowlingcentera.Adapterek.IdopontokAdapter;
import com.example.galaxybowlingcentera.AdatModellek.PalyafoglalasAdatai;
import com.example.galaxybowlingcentera.NotificationHandler;
...
public class PalyafoglalasActivity extends AppCompatActivity {
    ...
    public void napKivalasztas(View view) {
        ...
        @SuppressLint("SetTextI18n")
        DatePickerDialog dialog = new DatePickerDialog(this, AlertDialog.THEME_DEVICE_DEFAULT_DARK, (view1, ev, honap, nap) -> {
    ...
    public void foglalasLetrehozasa() {
        ...
        if (!melyikOra.isEmpty()) {
            ...
            mNotificationHandler.sendScheduledNotificationOra("Egy óra múlva bowlingozás. \nIdőpont: "+melyikIdopont+"  "+melyikOra+" óra. \nÁr: "+ar+"", kivalasztottEv, megfeleloHonap, kivalasztottNap, vizsgalandoOra);
            mNotificationHandler.sendscheduleNotificationNap("Holnap bowlingozás. \nIdőpont: "+melyikIdopont+"  "+melyikOra+" óra. \nÁr: "+ar+"", kivalasztottEv, megfeleloHonap, kivalasztottNap);
